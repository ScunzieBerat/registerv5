...
if(!message.member.roles.has('753301258865213604') && !message.member.hasPermission('ADMINISTRATOR')) return message.reply('Bu komutu Kullanmak için gerekli yetkiye sahip değilsin')
    ...
    await mesaj.react("753494063243591702")
    await mesaj.react("753494035414646875")
