...
if(!message.member.roles.get("753301258865213604") && !message.member.hasPermission('753301258865213604'))  return message.channel.send(new Discord.RichEmbed() .setDescription(`Bu komutu Kullanmaya Hakkın yok :x:`).setAuthor(message.author.tag ,message.author.avatarURL).setColor("RANDOM")).then(m => m.delete(5000));
    let kullanici = message.mentions.members.first()
    let chan = client.channels.get("753814918481969224")
    var muteTime = args[1];
...
.setColor("RANDOM"))    
        ...
        setTimeout(() => {
    let chan1 = client.channels.get("753814918481969224")
