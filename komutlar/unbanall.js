...
exports.run = async(client, message, args) => {
  ...
  if(!message.member.hasPermission("753301258332536963")) return message.reply('Bu Komutu Kullanabilmek İçin \`Kullanıcıları Yasakla\` Yetkisine Sahip Olmalısın').then(m => m.delete(10000))
