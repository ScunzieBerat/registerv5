...
exports.run = async (client, message, args) => {
    ...
    const filter = (reaction, user) => {
        return ['tik2', 'tik3'].includes(reaction.emoji.name) && user.id === rochelle1.id;
    ...
    await mesaj.react("753494063243591702") /// emoji id 
    await mesaj.react("753494035414646875")/// emoji id 
