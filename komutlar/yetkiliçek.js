...
exports.run = async(client, message, args) => {
  if (!message.member.hasPermission('753301234433261629')) return ; // BURAYA KOMUTU KULLANABİLECEK ROL ID
  let enAltYetkiliRolü = message.guild.roles.get('753301255627079740'); // EN ALT YETKILI ROLUNUN IDSI BURAYA
