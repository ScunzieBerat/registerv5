...
rochelle.setNickname(`ᛉ ${isim} '${yas}`)
  rochelle.addRole('753301292591611974'); // erkek 1
  rochelle.addRole('753301292591611974'); // erkek 1
  rochelle.addRole('753301292591611974'); // erkek 1
  rochelle.addRole('753301292591611974'); // erkek 1
  ...
  rochelle.removeRole('753301273134104597') // kayıtsız 1
  rochelle.removeRole('753301293291929729') // cezalı 1 717777340708552807 717743735705960448
...
db.add(`kadın.${message.author.id}`, 1);
  ...
  .setDescription(`**<a:tik3:753494215648083998> ${rochelle.user} Adlı Üye  <@&753301292591611974> Rolüyle Kayıt Oldu.** `)
