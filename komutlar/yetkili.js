...
if(!message.member.roles.has('753301255627079740') && !message.member.hasPermission('ADMINISTRATOR')) return message.reply('Kullanmağa Yetkin Yetmiyor Bilader')
  let enAltYetkiliRolü = message.guild.roles.get("753301255627079740"); // en alttaki rol id
